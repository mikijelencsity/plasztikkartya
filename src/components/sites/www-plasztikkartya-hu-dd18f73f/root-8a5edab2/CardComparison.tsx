  ...
  return (
    <div className="flex w-full max-w-[380px] flex-col gap-8 desk:max-w-none desk:flex-row desk:items-start desk:gap-10">
      <div className="flex flex-col desk:flex-1">
        <div className="relative left-[-60px] w-full tab:left-[20px] desk:left-0">
          <Image
      ...
      <div className="flex flex-col desk:flex-1">
        <div className="relative left-[-280px] w-[160%] max-w-none tab:left-0 tab:w-full desk:left-0 desk:w-full">
          <Image
